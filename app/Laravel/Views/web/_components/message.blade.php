                    ...
                    <div class="card login-signup-card shadow-lg mb-0">
                        <div class="card-body px-md-5 py-5">
                            <div class="text-center">
                                @if(($prefix == "APP" AND $transaction->application_transaction_status == "COMPLETED") || ($prefix == "PF" AND $transaction->transaction_status == "COMPLETED") || ($prefix == "OT" AND $transaction->transaction_status == "COMPLETED") || ($prefix == "RF" AND $transaction->transaction_status == "COMPLETED"))
                                    <span class="text-6xl">
                                ...
                                @elseif(($prefix == "APP" AND $transaction->application_transaction_status == "PENDING") || ($prefix == "PF" AND $transaction->transaction_status == "PENDING") || ($prefix == "OT" AND $transaction->transaction_status == "PENDING") || ($prefix == "RF" AND $transaction->transaction_status == "PENDING"))
                                    <span class="text-6xl">

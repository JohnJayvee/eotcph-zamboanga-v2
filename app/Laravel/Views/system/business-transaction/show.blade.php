          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-inline">
                {!!Form::select('collection_id',$fees,old('collection_id'),['id' => "input_collection_id",'class' => "custom-select ".($errors->first('collection_id') ? 'border-red' : NULL)])!!}

<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center">
    <a class="navbar-brand brand-logo" href="{{route('system.dashboard')}}"><img src="{{asset('web/img/oasap.png')}}" alt="logo"/></a>
    <a class="navbar-brand brand-logo-mini" href="{{route('system.dashboard')}}"><img src="{{asset('web/img/oasap.png')}}" alt="logo"/></a>
  </div>

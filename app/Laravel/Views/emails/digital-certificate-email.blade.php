...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 14px; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; line-height: 1.6em; margin: 0;">
	...
	<table class="center bg-white" width="55%">
				...
				<th colspan="2" class="primary" style="padding: 25px;">
					<div id="pageElement">
						<div style="float: left;color: #000;padding-left: 30px;">Thank You for using &nbsp;</div>
					  	<div style="padding-right: 30px;"> <img src="{{asset('web/img/zamboanga-oboss.png')}}" alt="" style="width: 130px;"> </div>
					</div>
				</th>
			</tr>
			...
			<tr>
				<th colspan="2">
					<p style="float: left;text-align: justify;">Congratulations! You have completed your Business Permit Renewal Application for your Business: {{$business_name}}.</p>
				</th>
			</tr>
			...
			<tr>
				<td><p>For more information or concerns, please contact the BPLO hotline: <br> Landline: 991-2565 <br> Globe: 0926-630-3210</p></td>
			</tr>
	</table>

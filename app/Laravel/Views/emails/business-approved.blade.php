	...
	<table class="center bg-white" width="55%">
			...
			<tr>
				<th colspan="2"><p style="float: left;text-align: justify;">Hello {{Str::title($full_name)}}, <p>
					<p style="float: left;text-align: justify;">Good day. We are pleased to inform you that your Business Application has been approved by our processor and is now for payment.</p>
				</th>
			</tr>
